...
export function ApiOnvifDevicePtzMoveAbsolute(arg1:string,arg2:ui.PtzControl):Promise<{[key: string]: any}>;

export function ApiOnvifDevicePtzMoveRelative(arg1:string,arg2:ui.PtzControl):Promise<{[key: string]: any}>;
